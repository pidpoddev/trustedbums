...
const routeInventory: WorkflowRoute[] = [
  ...
  { role: "CLIENT_ADMIN", path: "/client/agreements", heading: "Agreements", area: "Client", workflow: "Agreements" },
  ...
  { role: "CLIENT_FINANCE", path: "/client/agreements", heading: "Agreements", area: "Client Finance", workflow: "Agreements" },
  ...
  { role: "CLIENT_MEMBER", path: "/client/agreements", heading: "Agreements", area: "Client Member", workflow: "Agreements" },
  ...
  { role: "BUM", path: "/bum/prospects", heading: "Prospective Clients", area: "Bum", workflow: "Prospective clients" },
  { role: "BUM", path: "/bum/reverse-opportunities", heading: "Customer Leads", area: "Bum", workflow: "Customer leads" },
  { role: "BUM", path: "/bum/clients", heading: "Represented Clients", area: "Bum", workflow: "Client representation" },
